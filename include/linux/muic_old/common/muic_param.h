...
extern int legacy_get_uart_sel(void);
extern int legacy_get_afc_mode(void);
extern int legacy_get_pdic_info(void);
#else
static inline int legacy_get_switch_sel(void) {return 0; }
static inline int legacy_get_uart_sel(void) {return 0; }
