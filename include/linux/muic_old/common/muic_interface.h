...
extern struct muic_interface_t *legacy_muic_manager_init(void *pdata, void *drv_data);
extern void legacy_muic_manager_exit(struct muic_interface_t *muic_if);
int muic_manager_get_legacy_dev(struct muic_interface_t *muic_if);
extern void legacy_muic_manager_set_legacy_dev(struct muic_interface_t *muic_if, int new_dev);
