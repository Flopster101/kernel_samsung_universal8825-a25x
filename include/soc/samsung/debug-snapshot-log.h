...
/* Give default values if not set */
#ifndef CONFIG_DEBUG_SNAPSHOT_LOG_ITEM_SIZE
#define DSS_LOG_MAX_NUM			32
#else
#define DSS_LOG_MAX_NUM			CONFIG_DEBUG_SNAPSHOT_LOG_ITEM_SIZE
#endif
#ifndef CONFIG_DEBUG_SNAPSHOT_FREQ_DOMAIN_NUM
#define DSS_DOMAIN_NUM			1024
#else
